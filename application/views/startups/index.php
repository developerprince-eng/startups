...
<html lang="en">
  ...
  <head>
    ...
    <link href="assets/landing/css/card.css" rel="stylesheet">
    ...
    <link href="assets/landing/css/grayscale.min.css" rel="stylesheet">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#projects">List</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Plugin JavaScript -->
    <script src="assets/landing/vendor/font-awesome/js/all.js"></script>
    <script src="assets/landing/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for this template -->
    <script src="assets/landing/js/grayscale.min.js"></script>
