  ...
  <div id="footer">
    ...
    <!--
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/vendor/woocommerce-FlexSlider-53570ee/jquery.flexislider.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/vendor/woocommerce-FlexSlider-53570ee/jquery.flexislider-min.js"></script>
    -->
