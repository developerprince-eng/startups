  ...
  <body id="page-top">
    ...
    <section id="projects" class="projects-section bg-light">
     <div class="col-lg-12 mx-auto text-center">
     	<h2 class="text-black mb-4 text-center">Meet Our Contributors</h2>
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <hr class="my-4">
                <div class="small text-black-50">Bambanani Centre, 2nd Floor Cnr Jason Moyo & 9th Avenue</div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <hr class="my-4">
                <div class="small text-black-50">+263292272255</div>
              </div>
            </div>
          </div>
        </div>
