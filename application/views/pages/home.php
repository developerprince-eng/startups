        ...
        <div class="row">
          <div class="col-md-5">
            <div class="well well-lg custom-jumbo">
              ...
              <a href="#" class="btn btn-default btn-lg page-scroll">List your Startup</a>
            </div>
          </div>
          ...
          <div class="col-md-5">
            <div class="well well-lg custom-jumbo">
              ...
              <br>
              <a href="#" class="btn btn-default btn-lg page-scroll" style="margin-right: 1%;">Startup Registry</a>
    
              <a href="#" class="btn btn-default btn-lg page-scroll" style="float: right;">Become a Partner</a>
